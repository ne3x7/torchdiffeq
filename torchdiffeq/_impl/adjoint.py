...
class OdeintAdjointMethod(torch.autograd.Function):
    ...
    def forward(ctx, *args):
        ...
        y0, func, t, flat_params, rtol, atol, method, options, y_exog = \
        ...
        with torch.no_grad():
            ans = odeint(func, y0, t, y_exog, rtol=rtol, atol=atol, method=method, options=options)
        ctx.save_for_backward(t, y_exog, flat_params, *ans)
        return ans
    ...
    def backward(ctx, *grad_output):
        ...
        def augmented_dynamics(t, y_aug, exog_y):
            ...
            with torch.set_grad_enabled(True):
                ...
                print(t.item(), 't', torch.isnan(t[0]).any(), 'y', torch.isnan(y[0]).any(), 'exog',
        ...
        with torch.no_grad():
            ...
            for i in range(T - 1, 0, -1):
                ...
                func_i = func(t[i], ans_i, y_exog[i])
                ...
                aug_ans = odeint(
                    ...
                    torch.stack([y_exog[i], y_exog[i-1]]),
...
def odeint_adjoint(func, y0, y_exog, t, rtol=1e-6, atol=1e-12, method=None, options=None):
    ...
    if torch.is_tensor(y0):
        ...
        class TupleFunc(nn.Module):
            ...
            def forward(self, t, y, y_exog):
                return (self.base_func(t, y[0], y_exog),)
    ...
    ys = OdeintAdjointMethod.apply(*y0, func, t, flat_params, rtol, atol, method, options, y_exog)
